...
public class Ship implements Command {
    ...
    public void runCommand(MessageReceivedEvent event, List<String> args) {
        ...
        try {
            ...
            BotUtils.send(event.getChannel(), "Something went terribly wrong. Either you're retarded and can't type or Kat's retarded and should runDelete this entire repo");
        }
    }
    ...
    private String handleAdvice(IUser cupid, IUser psyche) {
        if (cupid.getStringID().equals(psyche.getStringID()))
            ...
            return BotUtils.getRandFromCollection(advice);
    }
